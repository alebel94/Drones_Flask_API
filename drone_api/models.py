...
# a decorator (@) takes a function and uses another function as parameter
# will give function and return function with more power
...
class Drone(db.Model):
    ...
    def __repr__(self):
        return f'The following Drone has been added: {self.name} which belongs tp {self.user_id}'
